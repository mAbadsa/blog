...
const getAllArticle = <T extends ArticleType>({
  ...
  const sql: QueryConfig = {
    ...
    u.location, u.github_account, u.website_url, u.created_at as user_created_at 
    FROM articles as a INNER JOIN users as u ON u.id = a.user_id WHERE a.status = 'published' LIMIT $1 OFFSET $2;`,
    values: [limit, offset],
  };
